<?php
/**
 * BIC-QA 智能分析 - 三 Tab 页面交互（.js.php）
 *
 * Zabbix 7.0 模块的 JS 必须通过 $this->includeJsFile() 加载 .js.php 文件（PHP 输出 JS）。
 * 本文件由 views/bicqa.main.php 的 includeJsFile() 引入，输出一段带 <script> 的内联 JS；
 * 整体包在 jQuery $(function(){}) 里，确保 DOM（#bicqa-app 容器）就绪后才执行。
 */
?>
<script>
$(function () {
